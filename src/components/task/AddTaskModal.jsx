...
export default function AddTaskModal({ onSave, updateTask, handleModalClose }) {

    const [input, setInput] = useState(updateTask || {
    ...
    // check the modal mode => edit or add
        ...
        <>
            ...
            >
                ...
                <div className="mt-16 flex justify-between lg:mt-20">
                    <button onClick={handleModalClose} className="rounded bg-red-600 px-4 py-2 text-white transition-all hover:opacity-80"> Close </button>
                    <button
                        type="submit"
                        className="rounded bg-blue-600 px-4 py-2 text-white transition-all hover:opacity-80"
                        onClick={(e) => onSave(e, input, isAdd)}
                    >
